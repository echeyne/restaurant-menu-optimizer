    ...
    return Consumer<AuthProvider>(
      builder: (context, authProvider, child) {
        ...
        return MaterialApp(
          ...
          initialRoute: authProvider.isAuthenticated ? AppRoutes.dashboard : AppRoutes.login,
          onGenerateRoute: (settings) {
            ...
            switch (settings.name) {
              ...
              case AppRoutes.dashboard:
                ...
                break;
              default:
                page = authProvider.isAuthenticated ? const DashboardScreen() : const LoginScreen();
            }
