...
class _MenuItemEditScreenState extends State<MenuItemEditScreen> {
  ...
  Future<void> _saveMenuItem() async {
    ...
    if (widget.item != null) {
      ...
      // Create new item - for now we'll use update since there's no create method
      // In a real implementation, you'd have a separate create method
      success = await menuProvider.updateMenuItem(menuItem.itemId, menuItem);
    }
